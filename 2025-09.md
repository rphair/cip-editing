...
* Proposing and writing specifications for comprehensive search features:
  * Links pointing to complete and reproducible queries: beyond the current arrangement only allowing selection of filters in a dialog box (https://github.com/cardano-foundation/cf-cip-frontend/issues/60)
  * Vocabulary terms allowing CIP editors and Cardano stakeholders to build reproducible lists of CIPs and CPSs meeting complex combinations of such filters (https://github.com/cardano-foundation/cf-cip-frontend/discussions/55)

... so that these long term CIP community needs can be addressed:
* On-demand display of:
  * CIPs which have been officially merged but are now "Waiting for Implementation" and need community support before being progressed & eventually declared `Active` (https://github.com/cardano-foundation/CIPs/issues/863#issuecomment-3302589223)
...
* Application of this "tagging" vocabulary to provide the same benefits believed to motivate creating the `CRC` (like Ethereum) in addition to the `CIP` (https://github.com/cardano-foundation/CIPs/issues/1040#issuecomment-3302528920)
...
Acknowledging community suggestion to keep considering CIP process for possible inclusion in the Cardano Constitution (pending interest from constitution draft authors), and placing this on informal Summit agenda: https://x.com/COSDpool/status/1971852442586214764
...
* Introducing demanding discussion at CIP meeting (with author present) and approving based on acceptable definition of problem: as separate from contemporary proposals for solution (https://github.com/cardano-foundation/CIPs/pull/1060#pullrequestreview-3177483561)

#1065 - CIP-0161? | Ouroboros Phalanx - Breaking Grinding Incentives
* Moderating cautious review from other editors (https://github.com/cardano-foundation/CIPs/pull/1065#pullrequestreview-3177499321)
* Addressing author's initial concerns that the CIP is not proceeding quickly enough toward merge (https://github.com/cardano-foundation/CIPs/pull/1065#issuecomment-3265406174)
...
* Qualifying as candidate, noting some reservations expressed at CIP meeting that could delay universal agreement on this method of addressing candidate CPS-0022 (https://github.com/cardano-foundation/CIPs/pull/1077)
...
* Noting relevance to other topics of chain block format & calling these proposal contributors for cross review: in hope of confirming this as a candidate (since failed to be recognised as such in the CIP meeting) (https://github.com/cardano-foundation/CIPs/pull/1084#issuecomment-3299748502)
