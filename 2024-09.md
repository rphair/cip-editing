...
With co-editor Ryan, trying to describe & plan a better process for dealing with metadata tag (label) requests (updates to CIP-0010) (https://github.com/cardano-foundation/CIPs/issues/914)
