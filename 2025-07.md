...
* Taking action on community report the standard is implemented, though author had effectively abandoned document: working with author to clean up document so it can be merged:
...
* Brutal but effective formatting review for new CIP author (https://github.com/cardano-foundation/CIPs/pull/1050#pullrequestreview-2994835418)
